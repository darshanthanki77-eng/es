...
import { Download, Filter, Calendar, DollarSign, Package, TrendingUp, BarChart3, FilePieChart } from 'lucide-react';
            ...
            <div className="space-y-8">
                ...
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div>
                        ...
                        <p className="text-gray-600">Deep dive into your store performance from original database data</p>
                    </div>
                    <div className="flex gap-3">
                        ...
                        <button onClick={exportToPDF} className="btn-primary shadow-lg shadow-primary-200">
                            <Download className="w-5 h-5 mr-2 inline" />
                            PDF Report
                        </button>
                    </div>
                            ...
                            <tbody className="divide-y divide-gray-100">
                                <tr>
                                    <td colSpan={5} className="px-6 py-20 text-center text-gray-500 italic">
                                        No performance data available in database for selected range.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
