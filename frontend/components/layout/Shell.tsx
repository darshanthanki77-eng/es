    ...
    return (
        <div className="min-h-screen bg-slate-50 relative">
            ...
            <div className="fixed top-0 left-0 w-full h-full pointer-events-none z-0">
                <div className="absolute top-[-10%] left-[-10%] w-[25%] h-[40%] bg-primary-500/5 rounded-full blur-[80px]" />
                <div className="absolute bottom-[-10%] right-[-10%] w-[25%] h-[40%] bg-purple-500/5 rounded-full blur-[80px]" />
            </div>
            ...
            <aside className={`
                fixed top-0 left-0 bottom-0 z-[70] w-72 bg-white border-r border-gray-100 
                ...
                <div className="flex flex-col h-full relative z-10">
                    <div className="p-8">
                        <div className="flex items-center gap-4">
                            <div className="relative p-3 bg-gradient-to-br from-primary-500 to-purple-600 rounded-2xl shadow-lg">
                    ...
                    <div className="p-6">
                        <div className="glass-card !bg-white/40 border-white/40 p-4 group cursor-pointer hover:!bg-white/60 transition-all duration-200">
                            <div className="flex items-center gap-3">
                                <div className="relative">
                                    <div className="w-12 h-12 bg-gradient-to-tr from-primary-500 to-purple-600 rounded-xl flex items-center justify-center text-white font-black text-lg shadow-lg group-hover:rotate-3 transition-transform">
                                ...
                                <div className="flex-1 overflow-hidden">
                                    <p className="text-sm font-bold text-gray-900 truncate">{user?.name || 'Guest Seller'}</p>
                                    <p className="text-[10px] text-gray-500 font-semibold truncate">{user?.email || 'Individual Plan'}</p>
                                </div>
            ...
            <div className="lg:pl-72 flex flex-col min-h-screen relative z-10">
                <header className="h-16 bg-white/80 backdrop-blur-xl border-b border-gray-100 sticky top-0 z-[50] flex items-center justify-between px-4 lg:px-8 transition-all shadow-sm">
                    <div className="flex items-center gap-4">
                        <button
                            onClick={() => setIsSidebarOpen(true)}
                            className="p-2.5 bg-gray-100 hover:bg-gray-200 rounded-xl lg:hidden transition-all"
                        >
                        ...
                        <div className="flex items-center gap-2 cursor-pointer group" onClick={() => router.push('/')}>
                            <div className="w-10 h-10 bg-gradient-to-br from-primary-600 to-purple-700 rounded-xl flex items-center justify-center shadow-md group-hover:scale-105 transition-transform">
                                <span className="text-white font-black text-xs">ESS</span>
                            </div>
                            <span className="hidden sm:block font-black text-lg tracking-tighter text-gray-900 ml-1">SmartSeller</span>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-3 lg:gap-4">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 px-3 sm:px-4 py-2 bg-gradient-to-r from-success-50 to-emerald-50 border border-success-100 rounded-2xl hover:shadow-md transition-all group"
                        >
                        ...
                        <button className="p-2.5 bg-gray-100 hover:bg-gray-200 rounded-2xl relative group transition-all shrink-0">
                            <Bell className="w-5 h-5 text-gray-600 group-hover:text-primary-600 transition-colors" />
                            <span className="absolute top-2.5 right-2.5 w-2 h-2 bg-danger-500 rounded-full border-2 border-white" />
                        </button>
                    </div>
                </header>
