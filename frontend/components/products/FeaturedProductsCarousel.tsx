    ...
    return (
        <div className="group premium-card overflow-hidden h-full flex flex-col">
            ...
            <div className="relative overflow-hidden bg-gray-100 aspect-square">
                ...
                <div className="w-full h-full bg-gradient-to-br from-primary-100 via-purple-100 to-pink-100 flex items-center justify-center transform group-hover:scale-110 transition-transform duration-500">
                    <div className="text-center">
                        <div className="w-24 h-24 mx-auto bg-white/50 backdrop-blur-sm rounded-2xl flex items-center justify-center mb-3">
            ...
            <div className="p-4 flex-1 flex flex-col">
                ...
                {/* Product Name */}
                <h3 className="font-bold text-gray-900 mb-2 line-clamp-2 flex-1">
                    {product.name}
                </h3>
